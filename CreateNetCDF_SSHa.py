...
if alll_800:
    ...
    DEFAULT_TASKS = [
        # y train (WITH radar)
        dict(
            root="/nfs/pancake/u4/data/prism/us/an81/r1503/ehdr/24km/ppt/daily/",
            years="2010:2017",
            var_name="ppt",
            out_path="/nfs/pancake/u5/projects/vachek/radar_ai/netcdf/y_train_24k.nc",
            include_text="adj_best_ppt",
        ),
    #    y val (WITH radar)
        dict(
            root="/nfs/pancake/u4/data/prism/us/an91/r2112/ehdr/24km/ppt/daily/",
            years="2023",
            var_name="ppt",
            out_path="/nfs/pancake/u5/projects/vachek/radar_ai/netcdf/y_val_24k.nc",
            include_text="adj_best_ppt",
        ),
     #   x train (NO radar)
        dict(
            ...
            years="2010:2017",
            var_name="ppt",
            out_path="/nfs/pancake/u5/projects/vachek/radar_ai/netcdf/x_train_24k.nc",
            include_text="cai_ppt",
        ),
      #  x val (NO radar)
        dict(
            ...
            years="2023",
            var_name="ppt",
            out_path="/nfs/pancake/u5/projects/vachek/radar_ai/netcdf/x_val_24k.nc",
            include_text="cai_ppt",
        ),
        # infer-only (NO radar)
        dict(
            ...
            years="2024",
            var_name="ppt",
            out_path="/nfs/pancake/u5/projects/vachek/radar_ai/netcdf/infer_24_24k.nc",
            include_text="cai_ppt",
        ),
        ...
        dict(
            ...
            years="1982:1985",
            var_name="ppt",
            out_path="/nfs/pancake/u5/projects/vachek/radar_ai/netcdf/infer80_85_24k.nc",
            include_text="cai_ppt",
        ),
    ]    
# else:
